...
// --- Robust "Add thread" (uses loadState/saveState so it can't drift) ---
function __plannerAddThread(){
  ...
  try{
    ...
    alert("Add thread failed: " + (e?.message || e) );
  }
}

// Delegated handlers (works even if markup shifts)
